...
-   Moved ``lenskit.data.movielens`` to :mod:`lenskit.data.sources.movielens`.
    The old module is preserved as a compatibility source for importing
    ``load_movielens``, but is deprecated and will be removed.
